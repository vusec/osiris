...
struct Prob_Parser : public cl::parser<float>{
    bool parse(cl::Option &O, StringRef ArgName, const std::string &ArgValue, float &Val);
};

typedef cl::opt<float, false, Prob_Parser> prob_opt;
