...
# Parameters
#
TEST_NAME=performance_counters
...
function do_performance_counters_exp {
	local TYPE=$1
	local EXP_RUNS=$2
	local PRE_CALLBACK=$3

	log "******************"
	log "****************** Performance counters experiment for $TYPE:"
	log "******************"
	...
	edfi_run_repeated_experiment $EXP_RUNS $EDFI_SEC_MILLIS $PRE_CALLBACK ltckpt_performance_counters_exp_cb NULL
...
do_performance_counters_exp baseline $BASELINE_EXP_RUNS ltckpt_performance_pre_gen_cb
...
do_performance_counters_exp bitmap $BITMAP_EXP_RUNS ltckpt_performance_pre_gen_cb
...
do_performance_counters_exp undolog $UNDOLOG_EXP_RUNS ltckpt_performance_pre_gen_cb
...
do_performance_counters_exp smmap $SMMAP_EXP_RUNS ltckpt_performance_pre_gen_cb
sudo rmmod $SMMAP_KO
...
do_performance_counters_exp fork $FORK_EXP_RUNS ltckpt_performance_pre_gen_cb
...
do_performance_counters_exp dune $DUNE_EXP_RUNS ltckpt_performance_pre_gen_cb
...
do_performance_counters_exp mprotect $MPROTECT_EXP_RUNS ltckpt_performance_pre_gen_cb
...
do_performance_counters_exp softdirty $SOFTDIRTY_EXP_RUNS ltckpt_performance_pre_gen_cb
